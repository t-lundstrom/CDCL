...
Total runtime is the runtime for 100 instances, which includes preprocessing where duplicate literals in clauses are removed, duplicate clauses are removed, and tautological clauses are removed.
